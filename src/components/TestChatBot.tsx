...
export default function TestChatBot() {
  ...
  const sendMessageStreaming = async () => {
    ...
    try {
      const payload: any = { 
        message, 
        aiModel: 'smart' // Always use Gemini 2.5 Flash
      }
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
          <div className="flex items-center justify-center">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-medium text-green-700">⚡ Gemini 2.5 Flash</span>
              <span className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full">ACTIEF</span>
            </div>
          </div>
        </div>
